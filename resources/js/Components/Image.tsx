...
const Image = ({ className, zoomable, ...props }: Props) => {
  const [src, setSrc] = useState<string | undefined>(props.src || ImageNotFound)
  ...
  return (
    <>
      <Modal
        ...
        zoomable={typeof zoomable === 'undefined' ? false : zoomable}
      >
        <button
      ...
      <img
        ref={imageRef}
        onClick={(e) => {
          if (error || !(typeof zoomable === 'undefined' ? false : zoomable)) return
